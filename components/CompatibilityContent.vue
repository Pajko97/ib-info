      ...
      <div class="flex flex-row">
          <div class="flex flex-col">
              ...
              <div class="flex flex-col">
                  ...
                  <p class="text-lg">Iphone 8 Series</p>
                  <p class="text-lg">Iphone X Series</p>
                  <p class="text-lg">Iphone 11 Series</p>
                  <p class="text-lg">Iphone 12 Series</p>
                  <p class="text-lg">Iphone SE 2020</p>
              </div>
          </div>
          ...
          <div class="flex flex-col">
              ...
              <div class="flex flex-col">
                  ...
                  <p class="text-lg">Pixel Series</p>
                  <p class="text-lg">Nexus Series</p>
