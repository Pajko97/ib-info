<template>
  <div class="mx-20 my-14 flex flex-col justify-center items-center">
   <!-- This shows a success message if the form was submitted correctly. -->
    <div v-if="success" class="absolute z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded bg-indigo-500 text-white text-lg p-4">
...
export default {
  ...
  methods : {
    ...
    sendMail(e) {
      ...
      this.$axios.post('https://stormy-thicket-17355.herokuapp.com/api/hint', {
